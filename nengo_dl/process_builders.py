...
class LowpassBuilder(OpBuilder):
    ...
    def __init__(self, ops, signals, config):
        ...
        # add broadcast dimensions (one at the beginning for minibatch dimension,
        # and others at the end to match input rank)
        assert self.input_data.minibatched and self.output_data.minibatched
